...
if __name__ == "__main__":
    ...
    memorize_one_v1_time = timeit.timeit('memorize_one(v)', 
                        setup='''
from vlite import VLite
from __main__ import memorize_one
v = VLite()
                        ''',
                        number=num_executions) / num_executions
...
text = "hello"
    ...
    memorize_many_v1_time = timeit.timeit('memorize_many(v)', 
                        setup='''
from vlite import VLite
from __main__ import memorize_many
v = VLite()
                        ''',
                        number=num_executions) / num_executions
...
v = VLite2()
    ...
    remember_many_v1_time = timeit.timeit('remember(v, text)', 
                        setup='''
from vlite import VLite
from __main__ import remember, memorize_many
v = VLite()
memorize_many(v)
text = "civil law"
                        ''',
